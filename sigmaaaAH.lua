...
function UILibrary:CreateWindow(title, width, height)
    ...
    OuterFrame.Size = UDim2.new(0, windowWidth, 0, windowHeight)
    OuterFrame.Position = UDim2.new(0.5, -windowWidth/2 + math.random(-50, 50), 0.5, -windowHeight/2 + math.random(-50, 50))
    ...
    -- Gradient background (Kavo style)
    local Gradient = Instance.new("UIGradient")
    Gradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(30, 30, 30)), ColorSequenceKeypoint.new(1, Color3.fromRGB(40, 40, 40))}
    ...
    TitleLabel.TextColor3 = Color3.fromRGB(0, 170, 255) -- Kavo blue
    ...
    ResizeButton.BackgroundColor3 = Color3.fromRGB(0, 170, 255) -- Kavo blue
    ResizeButton.Text = "↔"
    ...
    local function CreateTab(tabName)
        ...
        TabStroke.Color = Color3.fromRGB(0, 170, 255) -- Kavo blue
        TabStroke.Thickness = 1
        TabStroke.Parent = TabButton
        TabButton.Parent = TabContainer

        -- Hover effect (Kavo style)
        ...
        TabButton.MouseButton1Click:Connect(function()
            if currentTab ~= TabContent then
                ...
                TweenService:Create(TabButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(0, 170, 255), TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
                for _, otherTab in pairs(tabs) do
                    if otherTab.Button ~= TabButton then
                        TweenService:Create(otherTab.Button, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(35, 35, 35), TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
                    end
                end
            end
        end)
...
-- Creates a customizable button (Kavo style)
function UILibrary:CreateButton(container, text, callback)
    ...
    Stroke.Color = Color3.fromRGB(0, 170, 255) -- Kavo blue
    Stroke.Thickness = 1
...
-- Creates a toggle switch (Kavo style)
function UILibrary:CreateToggle(container, text, default, callback)
    ...
    Toggle.BackgroundColor3 = default and Color3.fromRGB(0, 170, 255) or Color3.fromRGB(50, 50, 50) -- Kavo blue when ON
    Toggle.Text = ""
    local Corner = Instance.new("UICorner")
    ...
    Toggle.MouseButton1Click:Connect(function()
        state = not state
        TweenService:Create(Toggle, TweenInfo.new(0.2), {BackgroundColor3 = state and Color3.fromRGB(0, 170, 255) or Color3.fromRGB(50, 50, 50)}):Play()
...
-- Creates a slider (supports Mobile and PC, Kavo style)
function UILibrary:CreateSlider(container, text, min, max, default, callback)
    ...
    SliderFill.BackgroundColor3 = Color3.fromRGB(0, 170, 255) -- Kavo blue
...
-- Creates a text input box (Kavo style)
...
-- Creates a dropdown menu (Kavo style)
function UILibrary:CreateDropdown(container, text, options, callback)
    ...
    for _, option in pairs(options) do
        ...
        OptionButton.MouseEnter:Connect(function()
            TweenService:Create(OptionButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(0, 170, 255)}):Play()
        end)
    ...
    DropdownButton.MouseEnter:Connect(function()
        TweenService:Create(DropdownButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(45, 45, 45)}):Play()
    end)
    DropdownButton.MouseLeave:Connect(function()
        TweenService:Create(DropdownButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(35, 35, 35)}):Play()
    end)
